...
export default function Maquinas() {
  ...
  const [familiaId, setFamiliaId] = useState({ id: -1 });
...
//     return data;
//   };
//   const { data: familias } = useQuery("familias", getFamilias, {
//     initialData: {
//       data: [],
//     },
//   });

//   const getSubFamilias = async (id) => {
//     const { data } = await axiosRequest(
//       "get",
...
//     return data;
//   };
//   const { data: subfamilias } = useQuery(
//     ["fetchData", familiaId],
//     () => {
//       return getSubFamilias(familiaId);
//     },
//     {
//       initialData: {
//         data: [],
